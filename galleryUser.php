...
<body data-aos-easing="slide" data-aos-duration="800" data-aos-delay="0">
	...
	<div class="hero-wrap" style="height: 800px;">
		...
		<canvas class="particles-js-canvas-el" width="1770" height="1642" style="width: 100%; height: 100%;"></canvas></div>
		<div class="container ">
			<div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">

				<div class="col-md-4 ftco-animate fadeInUp ftco-animated" data-scrollax=" properties: { translateY: '70%' }" style="transform: translateZ(0px) translateY(0%); text-align: center;">
					<img style="border-radius: 50%; opacity: 1; transform: translateZ(0px) translateY(0%);" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }" src="https://image.ibb.co/f5Kehq/bio-image.jpg" alt="image">
				</div>

				<div class="col-md-4 ftco-animate fadeInUp ftco-animated" data-scrollax=" properties: { translateY: '70%' }" style="transform: translateZ(0px) translateY(0%); text-align: left;">


					<h1 class="mb-4" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }" style="opacity: 1; transform: translateZ(0px) translateY(0%);">
						<b>Hi there, I'm Nouf Ali </b>
					</h1>
					<p style="color: rgb(255, 255, 255); font-size: 30px; opacity: 1; transform: translateZ(0px) translateY(0%);" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">
			...
			<div class="row">
				<div class="col-md-4 ftco-animate fadeInUp ftco-animated">
					<div class="blog-entry">
						<a href="blog-single.html" class="block-20" style="background-image: url('image_1 .jpg');"> </a>
				...
				<div class="col-md-4 ftco-animate fadeInUp ftco-animated">
					<div class="blog-entry" data-aos-delay="100">
						<a href="blog-single.html" class="block-20" style="background-image: url('image_2.jpg');"> </a>
						<div class="text p-4">
							<div class="meta mb-3">
								<div>
									<a href="#">July 12, 2018</a>
				...
				<div class="col-md-4 ftco-animate fadeInUp ftco-animated">
					<div class="blog-entry" data-aos-delay="200">
						<a href="blog-single.html" class="block-20" style="background-image: url('image_4 .jpg');"> </a>
						<div class="text p-4">
							<div class="meta mb-3">
								<div>
									<a href="#">July 12, 2018</a>
				...
				<div class="col-md-4 ftco-animate fadeInUp ftco-animated">
					<div class="blog-entry">
						<a href="blog-single.html" class="block-20" style="background-image: url('image_6.jpg');"> </a>
						<div class="text p-4 d-block">
							<div class="meta mb-3">
								<div>
									<a href="#">July 12, 2018</a>
				...
				<div class="col-md">
					<div class="ftco-footer-widget mb-4">
						...
						<p>Far far away, behind the word mountains, far from the
							countries Vokalia and Consonantia, there's fabric.</p>
					</div>
				</div>
				...
				<div class="col-md">
					<div class="ftco-footer-widget mb-4">
						...
						<ul class="list-unstyled">
							<li><div class="py-2 d-block">198 West 21th Street,
									Suite 721 riyadh 10016</div></li>
