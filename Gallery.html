		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="ftco-nav">
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item"><a
						href="maFav.php"
						class="nav-link">Favorite list</a></li>
					<li class="nav-item"><a
						href="Gallery.php"
					...
					<li class="nav-item cta"><a
						href="AddArtwork.php"
						class="nav-link"><span>Add Artwork</span></a></li>
				</ul>
			</div>
		</div>
	</nav>
			...
			<div class="row">
				<div class="col-md-4 ftco-animate fadeInUp ftco-animated">
					<div class="blog-entry">
						<a href="blog-single.html" class="block-20"
							style="background-image: url('image_1 .jpg');"> </a>
				...
				<div class="col-md-4 ftco-animate fadeInUp ftco-animated">
					<div class="blog-entry" data-aos-delay="100">
						<a href="blog-single.html" class="block-20"
							style="background-image: url('image_2.jpg');"> </a>
						<div class="text p-4">
							<div class="meta mb-3">
								<div>
									<a href="#">July 12, 2018</a>
				...
				<div class="col-md-4 ftco-animate fadeInUp ftco-animated">
					<div class="blog-entry" data-aos-delay="200">
						<a href="blog-single.html" class="block-20"
							style="background-image: url('image_4 .jpg');"> </a>
						<div class="text p-4">
							<div class="meta mb-3">
								<div>
									<a href="#">July 12, 2018</a>
				...
				<div class="col-md-4 ftco-animate fadeInUp ftco-animated">
					<div class="blog-entry">
						<a href="blog-single.html" class="block-20"
							style="background-image: url('image_6.jpg');"> </a>
						<div class="text p-4 d-block">
							<div class="meta mb-3">
								<div>
									<a href="#">July 12, 2018</a>
				...
				<div class="col-md">
					<div class="ftco-footer-widget mb-4">
						...
						<ul class="list-unstyled">
							...
							<li><a href="mailto:novrartist@gmail.com"
								class="py-2 d-block">novrartist@gmail.com</a></li>
						</ul>
					</div>
				</div>
