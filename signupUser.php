...
'</head>
 <!-- end css -->
          ...
          <div class="col-md">
             <div class="ftco-footer-widget mb-4">
              ...
              <ul class="list-unstyled">
                <li><div style="color:white;" class="py-2 d-block">198 West 21th Street, Suite 721 New York NY 10016</div></li>
  ...
  <!-- Link back to Colorlib can not be removed. Template is licensed under CC BY 3.0. --></p>
          </div>
        </div>
      </div>
    </footer>
