      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-4 sidebar ftco-animate fadeInUp ftco-animated" style="left: 100px;">
            ...
            <div class="sidebar-box ftco-animate fadeInUp ftco-animated">
              <h3>About Artist</h3>
              <p>berif description about him/her</p>
            </div>
          </div>
  ...
  <script>
    function myFunction(x) {
      ...
      if ( x.classList.contains( "fa-heart") ) {
          ...
          document.getElementById("liked").innerText = "0 people liked this artwork";
      }
      else {
          x.classList.remove( "fa-heart-o" ); // المفرغة
          x.classList.add( "fa-heart" ); // المتعبية
          document.getElementById("liked").innerText = "1 person liked this artwork";
      }
}
  </script>
