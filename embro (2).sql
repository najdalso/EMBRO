...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 11, 2020 at 07:04 PM
...
('FRVa32fd', 'njmkl45678', 'user', 'novra1315@gmail.com', 'nouf ali'),
('jcnmbg', 'bnmmmki567%$#', 'user', 'nfj@gmmr.fv', 'fmv'),
('meandmyself', 'asdfgh45678', 'artist', 'novr1512@hotmail.com', 'nouf ali');
...
INSERT INTO `artist` (`username`, `bio`, `approved`, `website`) VALUES
('meandmyself', '', 'no', '');
...
CREATE TABLE `artwork` (
  ...
  `comment_ability` varchar(5) NOT NULL,
